...
pub use wasm::{
    ...
    decompress_blob_if_needed, detect_blob_compression, estimate_parse_size, extract_vector_chunked,
    extract_vector_to_js, memory_warning,
    read_lazy_vector_range, read_rds_async, read_rds_from_blob, recommend_decompression_mode,
    recommended_chunk_size_mb,
